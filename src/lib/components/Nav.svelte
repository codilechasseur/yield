<script lang="ts">
	...
	import { LayoutDashboard, Users, FileText, ClipboardList, PlusCircle, Settings, BarChart2, Landmark, LogOut, Menu, X, Bug, Zap, Sun, Moon, Monitor, Server, Wallet } from 'lucide-svelte';
